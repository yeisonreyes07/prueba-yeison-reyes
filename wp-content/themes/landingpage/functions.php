...
/**
 * Enqueue scripts and styles. Añadi librerias de Bootstrap
 */
function landingpage_scripts() {
	wp_enqueue_style( 'montserrat', 'https://fonts.googleapis.com/css?family=Montserrat:400,600,800&display=swap', array(), 'all');
    ...
    wp_enqueue_script( 'landingpage-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'landingpage-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
